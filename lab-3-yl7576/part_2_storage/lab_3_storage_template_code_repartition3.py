...
def main(spark):
    ...
    people.repartition(100).write.parquet('hdfs:/user/yl7576/people_large_repart100.parquet')
    people.repartition(10).write.parquet('hdfs:/user/yl7576/people_large_repart10.parquet')
